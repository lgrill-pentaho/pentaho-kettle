...
public interface IMetaFileLoader<T> {
   ...
   */
  T getMetaForEntry( Repository rep, IMetaStore metaStore, VariableSpace space ) throws KettleException;
   ...
   * @throws KettleException
   */
  T getMetaForStep( Repository rep, IMetaStore metaStore, VariableSpace space )
    throws KettleException;
}
