 ...
 */
@Step( id = "PGBulkLoader", name = "BaseStep.TypeLongDesc.PGBulkLoader",
        description = "BaseStep.TypeTooltipDesc.PGBulkLoader",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Bulk",
        image = "BLKPG.svg",
        documentationUrl = "http://wiki.pentaho.com/display/EAI/PG+Bulk+Loader",
        i18nPackageName = "org.pentaho.di.trans.steps.pgbulkloader" )
