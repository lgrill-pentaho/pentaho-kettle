...
@Step( id = "LDAPOutput", name = "BaseStep.TypeLongDesc.LDAPOutput",
        description = "BaseStep.TypeTooltipDesc.LDAPOutput",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Output",
        image = "LDO.svg",
        documentationUrl = "http://wiki.pentaho.com/display/EAI/LDAP+Output",
        i18nPackageName = "org.pentaho.di.trans.steps.ldapoutput" )
